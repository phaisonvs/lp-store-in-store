...
function setupIframePlaceholders() {
  ...
  if (!carousel) {
    console.warn("Carrossel de prova social não encontrado para placeholders.");
    return;
  }
  ...
  carousel.addEventListener("click", function (event) {
    ...
    if (placeholder && placeholder.dataset.src) {
      ...
      if (card) {
        ...
        console.log("Iframe carregado para:", iframeSrc);
      }
    }
  });
  ...
  console.log("Placeholders de iframe configurados.");
}

...
function setupCtaButtonEffect() {
  ...
  ctaButton.addEventListener("touchstart", function (e) {
    ...
    this.classList.add("button-pressed");
    // Removido e.preventDefault() que estava impedindo o evento de clique
  });
  ...
  ctaButton.addEventListener("touchend", function (e) {
    ...
    // Adicionar rolagem até o formulário diretamente no touchend
    const formContainer = document.querySelector(".form-container");
    if (formContainer) {
      console.log("Rolando até o formulário (touch)");
      formContainer.scrollIntoView({ behavior: "smooth", block: "start" });
    } else {
      console.warn(
        "Elemento form-container não encontrado para rolagem (touch)"
      );
    }
  });

  // Adicionar evento de clique para rolagem suave até o formulário
  ctaButton.addEventListener("click", function () {
    ...
    if (formContainer) {
      ...
      console.warn("Elemento form-container não encontrado para rolagem");
    }
  });
...
function setupFormContainerFadeIn() {
    ...
    (entries) => {
      entries.forEach((entry) => {
        if (entry.isIntersecting) {
          ...
          console.log(
            "Animação fade-in de baixo para cima aplicada ao form-container"
          );
        } else {
          // Quando o elemento sair da viewport, remover as classes de animação
          // para que a animação possa ser acionada novamente quando voltar à viewport
          formContainer.classList.remove("animate__animated", "animate__fadeInUp");
          console.log(
            "Classes de animação removidas do form-container para permitir nova animação"
          );
        }
      });
    },
  ...
  console.log("Observer configurado para form-container (com repetição de animação)");
}

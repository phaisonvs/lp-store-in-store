...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // setupCtaButtonEffect(); // Comentado ou removido se não for mais necessário

  // Configurar smooth scroll para o botão CTA principal
  setupSmoothScroll();
});
...
function triggerImmediateEntranceAnimation() {
  ...
  // REMOVIDO: Animação imediata para o botão CTA principal
  ...
  const observerCallback = (entries, observer) => {
    entries.forEach((entry) => {
      ...
      if (
        ...
        targetElement.classList.contains("cta-button-container") || // Mantém para outros botões CTA
        targetElement.classList.contains("form-container") // Adiciona o form-container
      ) {
        console.log(
        ...
        // REMOVIDO: Animação específica para o botão CTA dentro do observer
        // if (ctaButton) {

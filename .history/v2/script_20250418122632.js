...
function triggerImmediateEntranceAnimation() {
  ...
  // Reunir todos os elementos que devem ser animados
  ...
  elementsToAnimate.forEach((element) => {
    // Remover qualquer classe de animação anterior que possa estar aplicada
    element.classList.remove("animate__animated", "animate__zoomIn");

    // Definir a opacidade inicial de 20% e tornar o elemento visível
    element.style.opacity = "0.2";
    element.style.visibility = "visible";
    element.classList.add("visible");

    // Após um pequeno delay, iniciar a transição para 100% de opacidade
    setTimeout(() => {

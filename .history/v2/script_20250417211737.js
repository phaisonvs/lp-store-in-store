...
function setupTypingEffect() {
  ...
  if (headingElement) {
    // Verificamos se o texto já foi inicializado para evitar duplicação
    if (
    ...
    setTimeout(() => {
      ...
      // Monitoramos o fim da animação de typing
      const handleAnimationEnd = (e) => {
        if (e.animationName === "typing") {
          ...
          // Adicionamos classe de conclusão após o término da animação

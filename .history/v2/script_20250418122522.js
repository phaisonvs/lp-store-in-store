...
function triggerImmediateEntranceAnimation() {
  // Seleciona todos os elementos alvo da animação
  const targets = document.querySelectorAll(
    ".svg-suf-desk, .svg-suf-mobile, .texto-faca-parte"
  );

  // Para cada elemento alvo
  targets.forEach((element) => {
    // Define opacidade inicial como 20%
    ...
    // Quando a animação terminar, garante que a opacidade seja 100%

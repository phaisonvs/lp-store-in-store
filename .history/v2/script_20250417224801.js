  ...
  if (sliderElement && typeof Glide !== "undefined") {
    try {
      new Glide(sliderElement, {
        type: "carousel", // Tipo carrossel para loop contínuo visualmente
        startAt: 0,
        perView: 2, // Mostrar 2 slides em telas maiores
        gap: 15, // Espaçamento entre slides
        autoplay: 5000, // Autoplay a cada 5 segundos
        hoverpause: true, // Pausar no hover
        breakpoints: {
          900: {
            // Abaixo de 900px
            perView: 1, // Mostrar 1 slide
          },
        },
      }).mount();
      console.log("Glide.js (Prova Social) inicializado.");
    } catch (error) {

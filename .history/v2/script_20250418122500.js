...
function triggerImmediateEntranceAnimation() {
  ...
  targets.forEach((el) => {
    // Primeiro torna o elemento visível, mas com baixa opacidade
    el.style.visibility = "visible";
    el.style.opacity = "0.2"; // Começa com 20% de opacidade
    ...
    // Monitora o fim da animação para garantir opacidade total
    el.addEventListener("animationend", function handler() {
      el.style.opacity = "1"; // Garante que termine com opacidade total

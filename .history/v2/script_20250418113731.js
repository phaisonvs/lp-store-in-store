...
/**
 * @description Configura animação de fade-in/out baseada em scroll usando IntersectionObserver e anime.js
 * @param {string} selector - Seletor CSS para os elementos alvo.
 * @param {object} options - Opções de configuração (once, delay, enterTranslateY, leaveTranslateY, etc.).
 */

...
function setupTypingEffect() {
  ...
  if (headingElement) {
    // Salvamos o texto original
    const textoOriginal = headingElement.textContent.trim();

    // Inicialmente, deixamos o elemento "vazio" e com largura zero
    ...
    setTimeout(() => {
      // Adicionamos a classe para ativar a animação de typing
      headingElement.classList.add("typing-active");

      // Registramos o evento de fim da animação de typing
      headingElement.addEventListener("animationend", function (e) {
        if (e.animationName === "typing") {
          console.log("Animação de typing concluída");

          // Podemos adicionar comportamentos após o término da animação
          // Por exemplo, adicionar uma classe para um efeito de destaque suave

...
function setupTypingEffect() {
  ...
  if (headingElement) {
    ...
    // Então iniciamos o typing após 2.5s para uma sequência harmoniosa
    setTimeout(() => {
      // Adicionamos uma classe para controlar a visibilidade inicial
      headingElement.classList.add("typing-active");

      // Registramos o evento de fim da animação
      headingElement.addEventListener("animationend", (e) => {
        if (e.animationName === "typing") {
          console.log("Animação de typing concluída");
          // Podemos adicionar ações após o término da digitação se necessário
        }
      });
    }, 2500);
  }

...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Código para garantir que todos os elementos sejam visíveis imediatamente
  document.addEventListener("DOMContentLoaded", function () {
    // Desconectar o animationObserver se existir
    if (window.animationObserver) {
      window.animationObserver.disconnect();
    }

    // Tornar todos os elementos com a classe animate-on-scroll visíveis
    ...
    // Garantir que outros elementos específicos também estejam visíveis

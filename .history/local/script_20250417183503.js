...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const setupScrollAnimations = () => {
    ...
    // Tornar todos os elementos visíveis imediatamente sem animação
    ...
    // Desativa o observer para evitar que afete os elementos
    state.animations.observer = null;
    state.animations.initialized = true;

    // Armazena o observer desativado na janela para referência
  ...
  const otherElements = document.querySelectorAll(
    ".section-the-news, .nossas-guides-container, .carousel"
  );
